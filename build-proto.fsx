...
let downloadProtoc() =
    ...
    if OperatingSystem.IsWindows() then
        if Environment.Is64BitOperatingSystem then
            downloadFile "https://github.com/protocolbuffers/protobuf/releases/download/v28.2/protoc-28.2-win64.zip" temp |> Async.RunSynchronously
        else 
            downloadFile "https://github.com/protocolbuffers/protobuf/releases/download/v28.2/protoc-28.2-win32.zip" temp |> Async.RunSynchronously
        ...
        if Environment.Is64BitOperatingSystem then
            downloadFile "https://github.com/protocolbuffers/protobuf/releases/download/v28.2/protoc-28.2-linux-x86_64.zip" temp |> Async.RunSynchronously
        else 
            downloadFile "https://github.com/protocolbuffers/protobuf/releases/download/v28.2/protoc-28.2-linux-x86_32.zip" temp |> Async.RunSynchronously
        let archive = ZipFile.Open(temp, ZipArchiveMode.Read)
        let protoc = 
            archive.Entries
